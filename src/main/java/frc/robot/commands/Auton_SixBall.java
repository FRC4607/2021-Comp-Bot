...
public class Auton_SixBall extends CommandBase {
    ...
    public Auton_SixBall(DrivetrainSubsystem drivetrain, ShifterSubsystem shifter, TurretSubsystem turret, FlywheelSubsystem flywheel,
